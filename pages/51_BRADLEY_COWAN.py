...
st.markdown("### FOUR_DIMENSIONAL_STOCK_MARKET_STRUCTURES_AND_CYCLES_BY_BRADLEY_COWAN_PDF_17")
get_pdf.get_pdf("FOUR_DIMENSIONAL_STOCK_MARKET_STRUCTURES_AND_CYCLES_BY_BRADLEY_COWAN_PDF_17")
