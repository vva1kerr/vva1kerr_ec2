...
st.markdown("### UNIBOMBER_MANIFESTO_KACZYNSKI_PDF_20")
get_pdf.get_pdf("UNIBOMBER_MANIFESTO_KACZYNSKI_PDF_20")

st.markdown(read_markdown_file("markdown/KACZYNSKI.md"))