...
if not check_login():
    st.stop()
st.set_page_config(layout="wide", page_title="GAINESVILLE FIXED WING SCROLLS")

st.markdown("### GAINESVILLE FIXED WING SCROLLS") 

# Read the markdown content
content = read_markdown_file("markdown/GAINESVILLE_FIXED_WING_SCROLLS.md")
